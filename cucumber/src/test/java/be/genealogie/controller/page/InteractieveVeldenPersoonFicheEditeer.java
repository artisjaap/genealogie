...
public class InteractieveVeldenPersoonFicheEditeer extends AbstractInteractiveVelden{

    public InteractieveVeldenPersoonFicheEditeer(World world) {
        super(world);
    }

    @Override
    public WebPagina huidigePagina() {
        return WebPagina.NATUURLIJK_PERSOON_FICHE_EDITEER;
    }
